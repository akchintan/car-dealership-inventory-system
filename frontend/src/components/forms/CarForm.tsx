      ...
      <form className="auth-form" onSubmit={handleSubmit} noValidate aria-busy={loading}>
        ...
        >
          <div className="form-field">
            ...
            />
            {errors.brand && (
              <p id="car-brand-error" className="form-message form-message--error" role="alert">
                {errors.brand}
              </p>
            )}
          </div>
          ...
          <div className="form-field">
            ...
            />
            {errors.model && (
              <p id="car-model-error" className="form-message form-message--error" role="alert">
                {errors.model}
              </p>
            )}
          </div>
          ...
          <div className="form-field">
            ...
            />
            {errors.year && (
              <p id="car-year-error" className="form-message form-message--error" role="alert">
                {errors.year}
              </p>
            )}
          </div>
          ...
          <div className="form-field">
            ...
            <input
              ...
              aria-describedby={errors.price ? 'car-price-error' : undefined}
            />
            {errors.price && (
              <p id="car-price-error" className="form-message form-message--error" role="alert">
                {errors.price}
              </p>
            )}
          </div>
          ...
          <div className="form-field">
            ...
            <input
              ...
              aria-describedby={errors.mileage ? 'car-mileage-error' : undefined}
            />
            {errors.mileage && (
              <p id="car-mileage-error" className="form-message form-message--error" role="alert">
                {errors.mileage}
              </p>
            )}
          </div>
          ...
          <div className="form-field">
            ...
            <select
              ...
              onChange={(event) =>
                updateField('status', event.target.value as CarFormValues['status'])
              }
              required
              aria-invalid={Boolean(errors.status)}
              aria-describedby={errors.status ? 'car-status-error' : undefined}
              style={{
                width: '100%',
                padding: '12px 14px',
                color: '#172033',
            ...
            {errors.status && (
              <p id="car-status-error" className="form-message form-message--error" role="alert">
                {errors.status}
              </p>
            )}
          </div>
